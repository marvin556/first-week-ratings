...
const FLOWS = {
  m: {
    ...
    taskContent: (emp, link) => `How did ${emp.first_name}'s days go? <a href="${link}" target="_blank" rel="noopener">Fill in the ratings here</a> - you can complete several days at once.`,
    texts: (emp) => ({
  ...
  h: {
    ...
    taskContent: (emp, link) => `How did the manager support ${emp.first_name} during the first week? <a href="${link}" target="_blank" rel="noopener">Fill in the ratings here</a> - you can complete several days at once.`,
    texts: (emp) => ({
